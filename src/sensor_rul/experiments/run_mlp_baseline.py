...
def main() -> None:
    ...
    plot_prefix = "mlp_baseline_fd001"
    args.results_dir.mkdir(parents=True, exist_ok=True)
    plots_dir = args.results_dir / "plots"
    csv_path = args.results_dir / "mlp_baseline_fd001.csv"
    json_path = args.results_dir / "mlp_baseline_fd001.json"
    history_path = args.results_dir / "mlp_baseline_fd001_history.json"
    history_csv_path = args.results_dir / "mlp_baseline_fd001_history.csv"
    predictions_path = args.results_dir / "mlp_baseline_fd001_predictions.csv"
